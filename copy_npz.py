...
def process_trajectory(traj_id):
    ...
    destination_folder = f"./input/hamlyn/trajectory_{traj_id}_accel_patched_input"
...
# ==== USAGE ====
for traj_num in range(5000, 5031): # trj 11 train sequences, change to 12 if needed
    source_folder = f"./hamlyn_data/trajectory_{traj_num}/"
